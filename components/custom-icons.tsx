...
// Ваша иконка Earth из прикрепленного SVG
export function CustomEarthIcon({ size = 24, color = '#FE5900' }: CustomIconProps) {
  return (
...
// Пример как добавить любую другую SVG иконку
// 1. Скопируйте код из вашего SVG файла
// 2. Замените <svg> на <Svg>
// 3. Замените <path> на <Path>
// 4. Замените все атрибуты kebab-case на camelCase (fill-rule -> fillRule, clip-path -> clipPath)
// 5. Замените fill="..." на fill={color} где нужно менять цвет
// 6. Добавьте пропсы size и color для управления иконкой

export default CustomEarthIcon;
